...
surveys_wide2 <- surveys %>% 
  ...
  arrange(Control) #combination of variables you want to keep and variables you want to spread across 
...
#quantile takes 2 values, then takes 1 or more numbers that are meant to be quantile values 
?quantile
